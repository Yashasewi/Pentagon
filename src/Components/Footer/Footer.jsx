          ...
          <ul className="flex items-center space-x-4">
            <li className="flex h-10 w-10 items-center justify-center rounded-full border">
              <a href="javascript:void()">
                <svg class="svg-icon h-6 w-6 text-blue-400" viewBox="0 0 20 20">
                  <path
                    fill="none"
            ...
            <li className="flex h-10 w-10 items-center justify-center rounded-full border">
              <a href="javascript:void()">
                <svg class="svg-icon h-6 w-6 text-blue-700" viewBox="0 0 20 20">
                  <path
                    fill="none"
            ...
            <li className="flex h-10 w-10 items-center justify-center rounded-full border">
              <a href="javascript:void()">
                <svg class="svg-icon h-6 w-6 text-blue-500" viewBox="0 0 20 20">
                  <path
                    fill="none"
            ...
            <li className="flex h-10 w-10 items-center justify-center rounded-full border">
              <a href="javascript:void()">
                <svg class="svg-icon h-6 w-6 text-red-600" viewBox="0 0 20 20">
                  <path
                    fill="none"
